...
success = 0; 
trialsize = 20;
multiple_peaks = 0; % how shifty each trials peaks are 
...
if success == 0 && perfect == 1 
  index = 0; normalization = 0;
...
elseif perfect == 0 && multiple_peaks == 0
  index = 0; normalization = 0;
  %amp = normrnd(26,5,8);
  ...
  sig = normrnd(2*rand(1,1),3,trialsize);
  noise = 50; noisetype = 'sinusoid'; frequency = 0.1;

elseif perfect == 0 && multiple_peaks == 1
  ...
  sig2 = normrnd(2*rand(1,1),3,trialsize); 
